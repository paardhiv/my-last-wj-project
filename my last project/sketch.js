...
path.velocityX = -(200 + 2*distance/150);


mainCyclist  = createSprite(70,150,20,20);
mainCyclist.addAnimation("MainRunning",mainRacerImg1);
...
function spawnCyclists(){
  if (frameCount % 120 === 0){
    ...
    Cyclist.y= Math.round(random(50,200));
    Cyclist.scale = 0.07
    Cyclist.velocityX = -(6 + 2*distance/150);
     ...
     switch(rand) {
       case 1: Cyclist.addAnimation("cycle1",pinkcyclist);       
               break;
       case 2: Cyclist.addAnimation("cycle2",yellowcyclist);
               break;
       case 3: Cyclist.addAnimation("cycle3",redcyclist);
               break;
       default: break;
     }
...
function  spawnObstacles(){
  if (frameCount % 320 === 0){
    ...
    Obstacles.velocityX = (6 + 2*distance/150);
     ...
     var rand = Math.round(random(1,3));
     switch(rand) {
       case 1: Obstacles.addImage("cycle1",obstacle1_img);       
               break;
       case 2: Obstacles.addImage("cycle2",obstacle2_img);
               break;
       case 3: Obstacles.addImage("cycle3",obstacle3_img);
               break;
       default: break;
     }
